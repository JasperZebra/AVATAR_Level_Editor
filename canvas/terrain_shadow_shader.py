...
// SHADOW_DARK = shadowed ground brightness at full strength. 0.5 (was 0.25) so
// shaded ground (e.g. under trees) stays readable while editing instead of going
// near-black — matched to the model shadow floor.
