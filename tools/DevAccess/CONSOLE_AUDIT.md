...
> |---|---|---|
> | "68 top-level console commands" | **80 dispatch arms** (79 completable — `check_cmds.py` discards `?` and adds `warp`). `players`, `admin_gui`, `kick`, `kickban` added 2026-08-05. | §1.1 |
...
### 1.1 Top-level console commands (80 dispatch arms — was 68 when written)
