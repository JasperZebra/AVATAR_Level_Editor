...
> |---|---|---|
> | "68 top-level console commands" | **76 dispatch arms** (75 completable — `check_cmds.py` discards `?` and adds `warp`) | §1.1 |
...
### 1.1 Top-level console commands (76 dispatch arms — was 68 when written)
