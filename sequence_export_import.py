...
# The system boxes a generated trigger graph depends on. These become the
# depload children; the game preloads them.
TRIGGER_BOXES = [
...
def generate_trigger_lua(sequence_name: str, trigger_entity_id: str,
                         camera_entity_id: str, duration: float) -> str:
    """Emit a Domino graph that plays `sequence_name` once, on trigger entry."""
